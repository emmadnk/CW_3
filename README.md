...
Описание проекта: Написан код, для вывода 5 последних банковских операций клиента. Работа через библиотеку json.

Запуск и установка проекта: Скопируйте SSH или HTTPS ссылку. Далее в Pycharm через кнопку Get Version Control, вставьте ссылку и нажмите кнопку Clone. Проект установлен. Настройте виртуальное окружение через poetry или pip для установки файлов проекта и дальнейшей работы.